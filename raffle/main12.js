...
{
	option_group = [option_one, option_two, option_three, option_four, option_five, option_six, option_seven, option_eight, option_nine, option_ten, option_eleven, option_twelve];
...
/*function theWait()
{
	for(i = 0; i < 3; i++)
	{
		document.getElementById("result_r").innerHTML =  i;
	}
	one_dot = document.getElementById("result_r").innerHTML =  ".";
	setTimeout(one_dot, 1000);
	two_dot = document.getElementById("result_r").innerHTML =  "..";
	setTimeout(two_dot, 2000);
}*/
